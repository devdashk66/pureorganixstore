    ...
    <nav className="container mx-auto py-3 ">
      <section className="flex items-center justify-between mx-6 relative border-b border-primary border-opacity-20">
        <Link className="py-1" href="/">
          <FaLeaf className="w-12 h-12 text-primary dark:text-white" />
        </Link>
        <div className="flex gap-3 items-center">
          ...
          <button
            ...
            className="p-2 hover:bg-primary hover:bg-opacity-20 rounded-lg transition-colors dark:hover:bg-white dark:hover:bg-opacity-20 text-zinc-900 dark:text-white"
          >
            <FaBars className="text-3xl dark:text-white " />
          </button>
        </div>
      </section>
